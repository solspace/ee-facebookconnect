...
if ( ! class_exists('Addon_builder_fbc'))
{
	require_once 'addon_builder.php';
}

class Addon_builder_data_fbc
{
	/**
	 * local cache array
	 * @var array
	...
	public function __call($method, $args)
	{
		...
		if ( ! in_array($method, $this->aob_non_static_friendly) AND
			 is_callable(array('Addon_builder_fbc', $method)))
		{
			return call_user_func_array(array('Addon_builder_fbc', $method), $args);
		}
	}
	//end __call
