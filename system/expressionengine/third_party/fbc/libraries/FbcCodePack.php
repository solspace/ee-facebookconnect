 ...
 * @link		http://solspace.com/docs/fbc
 * @license		http://www.solspace.com/license_agreement
 * @version		2.0
 * @filesource	fbc/libraries/FbcCodePack.php
 */
...
class FbcCodePack
{
	...
	public $langItems = array(
		...
		'missing_theme_html_exp'		=> 'There should be a folder called \'html\' inside your site\'s \'/themes/solspace_themes/fbc/%code_pack_name%\' folder. Make sure that it is in place and that it contains additional folders that represent the template groups that will be created by this code pack.',
		...
		'missing_code_pack_theme_exp'	=> 'There should be at least one theme folder inside the folder \'%code_pack_name%\' located inside \'/themes/fbc/\'. A theme is required to proceed.',
	...
	public function detectInternalCodePack()
	{
		$this->internalCodePack	= ! (
			get_class($this) === 'FbcCodePack' &&
			//why the need for this? Well sometimes PHP was doing
			// (get_class($this) === 'FbcCodePack') === true where
	 ...
	 * /some/path/my_sweet_addon/fbc/ would return: my_sweet_addon
	 *
	 * @access	public
